...
/**
 * https://commons.apache.org/proper/commons-net/examples/telnet/TelnetClientExample.java
 *
 ...
 * terminal type will be subnegotiated. Also, use of the sendAYT(),
 * getLocalOptionState(), getRemoteOptionState() is demonstrated. When
 * connected, type AYT to send an AYT command to the server and see the result.
